...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.style-4', { style: 'fade-left', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-3', { style: 'fade-right', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-1', { style: 'fade-left', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons-component.style-1', { style: 'fade-up', speed: 1000, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.style-3', { style: 'fade-up', speed: 750, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-2', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-7', { style: 'fade-right', speed: 1000, intensity: 10, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-9', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-6', { style: 'fade-left', speed: 750, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons-component.style-1', { style: 'fade-up', speed: 1000, intensity: 3, threshold: 3, delay: 250, stagger: 125, staggerSelector: ':scope > li', replay: false });
